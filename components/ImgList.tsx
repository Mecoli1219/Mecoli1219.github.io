...
export default function ImgList({ imgList }: { imgList: string[] | string[][] }) {
    ...
    >
        {
            typeof imgList[currentIndex] === "string" ?
                ...
                :
                <div style={{ backgroundImage: `url(${imgList[currentIndex][0]})` }} className={`w-full h-[calc(100%-24px)] round-2xl bg-center duration-500 bg-no-repeat bg-white dark:bg-black ${imgList[currentIndex][1]}`}>
                </div>
        }
