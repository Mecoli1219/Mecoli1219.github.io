            ...
            <div className="max-h-90screen max-sm:max-h-80screen overflow-y-scroll overscroll-contain bg-[#F1F1F1] dark:bg-gray-700 rounded-lg xl:w-4xl lg:w-3xl md:w-2xl sm:w-xl w-80screen " onClick={(e) => { e.stopPropagation(); }}>
                <div className="flex flex-col">
                    ...
                    <div className="p-4 my-10 text-center flex flex-col items-center">
                        ...
                        <a href={"https://github.com/NTUEELightDance/LightDance-Editor"} className="hover:bg-white hover:dark:bg-gray-800 rounded-lg  hover:shadow-lg p-2 font-bold text-xl text-center w-fit flex flex-row cursor-pointer underline">
                            <svg
                        ...
                        <a href={"https://www.youtube.com/@ntueelightdance6849"} className="hover:bg-white hover:dark:bg-gray-800 rounded-lg  hover:shadow-lg p-2 font-bold text-xl text-center mb-5 w-fit flex flex-row cursor-pointer underline">
                        ...
                        <div className="text-gray-400 dark:text-gray-300 text-left max-sm:text-sm  px-2 sm:px-5 md:px-20">
                            The NTUEE Light Dance Editor is a web-based editor for the NTUEE Light Dance Team. It enables users to create and edit light dance shows through a user-friendly interface. The editor supports simultaneous editing by multiple choreographers. Additionally, it provides an interface to connect with the light dance system, allowing control over lights and music during performances.
                        </div>
                        <div className="font-bold text-2xl mb-2 mt-10">
                            【Features】
                        </div>
                        <ul className="list-disc text-gray-400 dark:text-gray-300 text-left max-w-full w-fit list-outside max-sm:text-sm px-2 sm:px-5 md:px-20">
                            <li>
                                Enable comprehensive editing, allowing adjustments to each part of the dancers and their positions for a fully customizable experience.
                            </li>
                            <li>
                                Support different light sources, including LED strips, Fiber Optics, etc.
                            </li>
                            <li>
                                Enable choreographers to copy and paste light patterns from one dancer to another.
                            </li>
                            <li>
                                Support simultaneous editing by multiple choreographers.
                            </li>
                            <li>
                                Provide a real-time preview of the show.
                            </li>
                            <li>
                                Support the ability to export and import shows to files, facilitating future editing and collaboration.
                            </li>
                            <li>
                                Provide an interface to connect with the Raspberry Pis, allowing control over lights and music during performances.
                            </li>
                        </ul>
                        <div className="font-bold text-2xl mb-2 mt-10">
                            【Tech Stack】
    ...
    return <>
        ...
        >
            <div className="flex flex-col p-5 md:p-2 justify-center items-center content-center">
                ...
                bg-[url('/static/portfolio/lightdance/lightdance.webp')] 
                hover:bg-[url('/static/portfolio/lightdance/lightdance.gif')] " />
