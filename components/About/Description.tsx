    ...
    return (
        <div className="bg-white dark:bg-gray-600 py-12 px-2 sm:px-12 flex flex-row max-sm:flex-col rounded-lg shadow-md">
            ...
            <div className="text-base text-gray-500 dark:text-gray-300 indent-8 text-left sm:basis-3/5 xl:basis-4/6">
                <div className="pb-3">
                    Hello! My name is <b>Chun-Mao Lai (賴群貿)</b>, and I am also known as <b>Michael</b> or <b>Mecoli</b>. My personal interests include playing piano, composing music, and building websites.
                </div>
                <div className="pb-3">
                ...
                <div className="">
                    Fun Fact: &apos;Mecoli&apos; is a playful fusion of Michael Lai&apos;s pronunciation and the name of the bacteria E.coli.
                </div>
            </div>
            {/* Image Part */}
